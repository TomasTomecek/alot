...
folders_statusbar = mixed_list(string, string, default=list('{saved_search_messages} watched messages', '{folders_count} folders'))
...
# configuration related to folders buffer
[folders]
    blacklisted_folders = force_list(default=list())
    [[saved_searches]]
